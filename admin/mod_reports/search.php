	...
	<div class="panel ">
		...
		<h4>Status :: </h4>
		  ...
		  <select name="categ" class="form-control">
		  	<option value="Startrd" <?php echo isset($_POST['categ']) && $_POST['categ'] == 'Started' ? 'selected' :'' ?>>Started</option>
		  	<option value="Ended" <?php echo isset($_POST['categ']) && $_POST['categ'] == 'Ended' ? 'selected' :'' ?>>Ended</option>
