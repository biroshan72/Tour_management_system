	      ...
	      <div class="container">
	        ...
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
	            ...
	            <li class="<?php echo (currentpage() == 'mod_room') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_room/index.php">Place</a></li>
	            <li class="<?php echo (currentpage() == 'mod_accomodation') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_accomodation/index.php">Transportation Mode</a></li>
